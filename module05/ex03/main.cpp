...
/*   Updated: 2021/01/23 19:41:29 by larosale         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main() {
    ...
    Intern  intern;
    Form*   rrf;
    rrf = intern.makeForm("shrubbery creation", "Home");
    if (rrf)
    {
        std::cout << *rrf;
    }
    ...
    rrf = intern.makeForm("presidential pardon", "Felon");
    if (rrf)
    {
        std::cout << *rrf;
    }
    rrf = intern.makeForm("unknown", "target");
    if (rrf)
    {
        std::cout << *rrf;
    }
